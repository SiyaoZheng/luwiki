...
source_count: 5
sources:
  - raw/2026-08-07-luyao-b023-115-这是一篇把-世界模型-讲明白的科普级综述！-183f0743.md
  - https://github.com/datawhalechina/learn-world-model/tree/main
  - raw/2026-08-07-luyao-b035-172-“Token”必须死？-7a5b8f31.md
  - "[[灵初智能]]"
  - "[[VAST]]"
tags:
  - 世界模型
...
- [[raw/2026-08-07-luyao-b023-115-这是一篇把-世界模型-讲明白的科普级综述！-183f0743]]
- [learn-world-model](https://github.com/datawhalechina/learn-world-model/tree/main)
- [[raw/2026-08-07-luyao-b035-172-“Token”必须死？-7a5b8f31]]
- [[灵初智能]]
- [[VAST]]
...
证据：[[raw/2026-08-10-合成轨迹与机器人世界模型公开证据]]、[RLDX-1](https://arxiv.org/html/2605.03269)、[dWorldEval](https://arxiv.org/abs/2604.22152)。
...
- [[HIL-SERL]] 的 reward classifier 已进入在线 actor→SAC learner，但走专用 `predict_reward()` 路径，不能证明统一 rewards API 已完成在线接线。
...
[[北京章鱼灵动科技有限公司|章鱼动力]]在[[2026 世界机器人大会|WRC 2026]]发布[[SYNWorld]]，区分ACWM动作可控世界模型与WAM世界动作模型：前者用于根据动作预测未来状态、辅助仿真评估，后者同时预测结果并生成机器人动作。媒体给出的V0.5参数口径存在“160亿”与“10B+”差异；公司所称部分场景虚实评估一致性超过80%尚无公开第三方基准。该案例可用于观察世界模型从视频预测走向动作条件建模，但不能据此确认通用操作能力。
