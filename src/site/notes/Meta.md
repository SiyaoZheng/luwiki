...
Meta 是运营社交平台、通信产品、AI 与虚拟现实业务的全球科技公司节点。

## 身份与层级

- Meta 品牌与具体子公司、研究团队和产品组织不能互换。

## 当前网络角色

- Thinking Machines Lab 的团队材料把前 Meta 经历列为部分成员的组织前史；在人物未逐名核验前不建立图边。

## 证据等级与边界

- **证据**：A：Meta 官方公司入口；人员关系需逐人核验。
- **不能推出**：共同前雇主不等于新公司获得 Meta 投资、授权或业务合作。
