...
source_count: 22
sources:
  - raw/2026-08-07-luyao-b040-195-机器人学习的“燃料”：人类数据，一场静悄悄的革命-221d0b6a.md
  - raw/2026-08-10-人类活动到机器人训练外部补证.md
  - raw/2026-08-10-Project-Aria-Research-Community-Guidelines核验.md
  - raw/2026-08-10-LeRobot-v0.6-HIL记录语义核验.md
  - raw/2026-08-10-UMI后续规模3D触觉谱系核验.md
  - "[[FastUMI]]"
  - "[[UMI-3D]]"
  - "[[DexUMI]]"
  - "[[TacUMI（多模态事件分割）]]"
  ...
  - "https://proceedings.mlr.press/v205/nair23a.html"
  - "https://arxiv.org/abs/2606.06627"
  ...
  - "https://huggingface.co/docs/lerobot/v0.6.0/inference"
  - "https://raw.githubusercontent.com/huggingface/lerobot/refs/tags/v0.6.0/src/lerobot/rollout/strategies/dagger.py"
tags: [具身智能, 机器人数据, 行为克隆, 第一视角数据, 人机数据转换]
created: 2026-08-07
updated: 2026-08-10
---
# 人类活动数据
...
证据：[[raw/2026-08-10-UMI后续规模3D触觉谱系核验]]
...
- [[raw/2026-08-10-人类活动到机器人训练外部补证]]
- [[raw/2026-08-07-luyao-b040-195-机器人学习的“燃料”：人类数据，一场静悄悄的革命-221d0b6a]]
...
证据：[[raw/2026-08-10-开放机器人学习数据集与格式基线]]
...
证据：[[raw/2026-08-10-LeRobot-v0.6-HIL记录语义核验]]
...
[[人类视频到机器人策略学习]]进一步把 2025–2026 年路线分成四级：[[EgoLive]] 是感知语料；[[VITRA]]、[[EgoVerse]] 与 [[EgoScale]] Stage I 重建人手／腕／相机 pose；[[Ego2Robot]] 与 [[EgoEngine]] 合成机器人画面或可执行动作；EgoScale Stage II、VITRA fine-tune、EgoVerse 与 [[EgoHumanoid]] 则重新引入目标机器人数据或 task-specific simulation。
...
证据：[[raw/2026-08-10-规模化人类视频到机器人预训练路线核验]]
...
证据：[[raw/2026-08-10-EgoMimic数据许可与参与者授权核验]]
...
[[raw/2026-08-10-Project-Aria-Research-Community-Guidelines核验|Project Aria Research Community Guidelines]] 提供的是 partner 采集行为底线：依法通知／同意、可见录制信号、旁观者停止和删除、场地方授权、敏感地点禁录、controller 透明度、留存／访问／删除、去标识与禁止重识别。它没有给数据接收者训练、再分发或商业使用权，也不证明某一项目已经实际执行全部流程。

因此第一视角人类活动数据至少要分别记录：设备信号是否发出、旁观者能否感知并理解、谁是 controller、停止／删除如何跨原始数据和派生制品传播、项目伦理／场地依据，以及具体数据集许可。[[可穿戴设备录制提示]] 追踪信号层的可感知性；[[Nymeria]] 追踪 Project Aria 数据集自己的治理与许可，不把社区规则当统一开源标签。

证据：[[raw/2026-08-10-Project-Aria-Research-Community-Guidelines核验]]

<!-- issue: luwiki-s1f -->

## 2026-08-26 enrich｜OctoSense与人类操作数据

[[北京章鱼灵动科技有限公司|章鱼动力]]公开的[[OctoSense]]方案把第一视角视频、[[SynEMG]]肌电、外骨骼手部动作与触觉信号并置，属于从人类自然操作中采集具身训练数据的企业路线。[[EgoBio（章鱼动力）]]与[[章鱼动力 Ego 数据采集路线]]是其进一步核验入口。现有公开材料只支持设备和采集模态的展示，不支持“肌电等同意图”、跨个体稳定迁移、规模化数据供给或已获充分数据授权等更强结论。
