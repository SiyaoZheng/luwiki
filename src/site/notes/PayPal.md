...
PayPal 是数字支付与在线结算公司节点。

## 身份与层级

- 品牌、上市控股公司和历史并购阶段需要按时间区分。

## 当前网络角色

- Palantir 的早期创始网络经由人物中转：[[Peter Thiel\|Peter Thiel]] 的 SEC 履历记录其于 1998 年共同创办 PayPal，并历任 CEO、President 和 Chairman。该人物关系不构成 PayPal 与 Palantir 的直接组织边。

## 证据等级与边界

- **证据**：A：PayPal 官方历史与事实页；Palantir 关系需公司/人物资料交叉核验。
- **不能推出**：“PayPal 前员工网络”不等于 PayPal 孵化、投资或控制 Palantir。
...
- 原始资料快照（本地归档）
- [官方入口](https://about.pypl.com/who-we-are/history-and-facts/default.aspx)
